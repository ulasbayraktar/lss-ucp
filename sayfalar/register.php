   	...
   	if(isset($_POST['submit_registration'])) 
   	{
		...
		else
		{
			if($_SESSION['already_submitted'] != 6)
			{
	            ...
	            $mail->Subject = 'LS-RP Türkiye Hesap Bilgileri';
	            $mail->Body    = '<b>Los Santos Roleplay\'e Hoşgeldin!</b><br><br>Los Santos Roleplay\'de aşağıdaki bilgileri içeren bir hesabı başarıyla kaydettiniz.<br><br><b>Kullanıcı Adı:</b> '.$kullanici_adi.'<br><b>Şifre:</b> '.$sifre.'<br><br>Artık hesap bilgilerinizle Kontrol Panelimize giriş yapabilirsiniz. (<a href="https://ls-rp.web.tr">ls-rp.web.tr</a>)<br><br>Saygılarımızla,<br>Los Santos Roleplay Yönetim Ekibi.';
					...
					$user->AddUCPMsg(0, $to_id, 'Hoşgeldin', 'LS-RP Türkiye\'ye hoşgeldin, <b>'.$kullanici_adi.'</b>!<br><br>Bu sizin karakterlerinizi yönetmek için kullanacağınız ana hesabınızdır. Sunucuda oynamanız için sadece ana hesabınız yetmez, bu yüzden <a href="index.php?page=char&action=new" target="_blank">karakter oluşturmak</a> zorundasınız. Karakter başvurunuz yönetim ekibi tarafından kabul edilirse oyun sunucumuzda (role)play yapmaya başlayabilir ve karakterinizi UCP üzerinden yönetebilirsiniz.<br><br>Bu UCP (Kullanıcı Kontrol Paneli) sizin spawn noktanızı, kıyafetinizi ve daha fazlasını değiştirmenizi sağlar. Bol şans diliyoruz!<br><br>Eğer bir sorunuz olursa, forum yada destek sitemizi kullanın.<br><br>Saygılarımızla,<br>Los Santos Roleplay', $kayit_tarihi);
...
<div class="cont">
   <br><br><font size="5">&raquo; Los Santos Roleplay — Hesap Oluşturma Sayfası </font><br><br>
	...
	switch($_SESSION['register_step'])
   	{
   		default:
		{
	        ...
	        echo '
	            ...
	            <center>
	               <div class="notice">
	                  <b>Şu anda LS-RP Türkiye platformu üzerinde bir "hesap" oluşturmak üzeresin. Bu hesabı oluşturduktan sonra yine buradan maksimum üç olmak şartıyla kendine oyun içi karakter oluşturabilirsin. Tek yapman gereken aşağıdaki sorulara doğru yanıtları vererek diğer adımlara ilerlemen. Bol şans!<br />
	                  ...
	                  <br /><br>
	                  &bull; Tüm soruları cevaplayabilmek için, <a target="_blank" href="http://forum.ls-rp.web.tr/viewforum.php?f=11"><img src="images/go_friend.gif" width="12"> sunucu kuralları</a> konusunu okumak zorunda kalacaksın.</b>
	               </div>
	            </center>
        	...
        	echo '
				...
				<table with="80%" align="center">
					<tr>
						...
						Bu şartları, <a href="https://forum.ls-rp.web.tr/viewforum.php?f=11">sunucu ve forum kurallarını</a> kabul ediyorsanız - aşağıdaki kutuya "<b>kabul ediyorum</b>" yazın. (tırnak olmadan)
						</td>
					</tr>
				</table>
